...
configures a user for them. They show the same thing for an operator, which is worth comparing:
this blueprint is about serving it to YOUR users, in your application, without sending them to
the tooling of a BPMS they should not need to know. Where they are served and how to log in is
in the
