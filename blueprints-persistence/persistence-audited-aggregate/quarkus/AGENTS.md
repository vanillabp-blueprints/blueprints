...
| `loan-approval/src/main/java/.../loanapproval/audit/AuditedAggregatePersistence.java`      | `getAuditingId` and `loadByIdAndAuditingId`: the two methods VanillaBP asks, the early revision, and the query reading the trail |
